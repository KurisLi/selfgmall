...
public class AttrController {
     ...
     */
    @GetMapping
    public Resp<PageVo> queryAttrByCatIdandLevel(@RequestParam(value = "type") Integer type,
                                                 @RequestParam(value = "cid") Long cid,
                                                 QueryCondition queryCondition){
        PageVo pageVo = attrService.queryAttrByCatIdandLevel(type,cid,queryCondition);
