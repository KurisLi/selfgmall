...
/**
 * @author lzzzzz
 * @create 2020-01-05 22:18
 */
@RestController
public class OssController {

    @GetMapping("/pms/oss/policy")
    public Resp<Object> policy(){
        String accessId = "LTAI4FcCXUZag4xxdgzNhyY1"; // 请填写您的AccessKeyId。
        String accessKey = "WcfDL1OXu1nohwEcvqoSXp2GWmQs6i"; // 请填写您的AccessKeySecret。
