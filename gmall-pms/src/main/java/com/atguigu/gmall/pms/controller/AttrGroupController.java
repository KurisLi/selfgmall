...
public class AttrGroupController {
     ...
     */
    @GetMapping("{catId}")
    public Resp<PageVo> queryAttrGroupByCatId(@PathVariable(value = "catId") Long catId,QueryCondition queryCondition){
        PageVo pageVo = attrGroupService.queryAttrGroupByCatId(queryCondition,catId);
